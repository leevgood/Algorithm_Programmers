...
#### Level 0
* [입출력 ReadLine(), WriteLine() 활용](<CSharp/Basic_Input and Output.md>)
* [입출력2 WriteLine(), ReadLine() 활용](<CSharp/Basic_Input and Output2.md>)
...
* [문자열 덮어쓰기(Substring(), Length활용)](<CSharp/OverWirte_String.md>)
...
* [닉네임 규칙 반복문(while 활용)](<./Python/Nickname_Rules.md>)
...
* [조건에 맞게 수열 변환하기2(bool 자료형 활용)](<CSharp/Sequence_Transformation2.md>)g
